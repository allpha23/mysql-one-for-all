...
INSERT INTO SpotifyClone.music (music, time_sec, album_id)
VALUES
  ('Soul For Us', 200, 1),
...
CREATE TABLE SpotifyClone.customer(
  ...
  customer(50) NOT NULL,
  age INT NOT NULL,
  subscribe_date DATE NOT NULL,
  FOREIGN KEY (plan_id) REFERENCES SpotifyClone.plan (plan_id)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.customer (plan_id, age, subscribe_date)
VALUES
...
CREATE TABLE SpotifyClone.history(
  ...
  PRIMARY KEY (customer_id, music_id),
  FOREIGN KEY (customer_id) REFERENCES potifyClone.customer (customer_id),
  FOREIGN KEY (music_id) REFERENCES potifyClone.music (music_id)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.history (customer_id, music_id, play_date)
VALUES
...
CREATE TABLE SpotifyClone.artist_favorite(
  customer_id INT NOT NULL,
  artist_id INT NOT NULL,
  PRIMARY KEY (customer_id, artist_id),
  FOREIGN KEY (customer_id) REFERENCES potifyClone.customer (customer_id),
  FOREIGN KEY (artist_id) REFERENCES potifyClone.artist (artist_id)
) ENGINE = InnoDB;

INSERT INTO SpotifyClone.artist_favorite (customer_id, artist_id)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
